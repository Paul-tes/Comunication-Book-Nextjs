...
export function TeacherSidebar() {
  ...
  const routes = [
    ...
    },
    {
      ...
      icon: BookOpen,
      href: "/teacher/marks",
      isActive: pathname === "/teacher/marks",
    },
    {
      title: "Homework & Engagement",
      icon: FileText,
      href: "/teacher/homework",
      isActive: pathname === "/teacher/homework",
    },
    {
      title: "Messages",
      icon: MessageSquare,
      href: "/teacher/messages",
      isActive: pathname === "/teacher/messages",
    },
  ]
    ...
    <Sidebar collapsible="icon" className="z-20">
      <SidebarHeader className="flex items-center gap-2 px-4 py-2">
        <div className="flex items-center gap-2">
          ...
          {state === "expanded" && <span className="text-lg font-semibold">Teacher Portal</span>}
        </div>
      </SidebarHeader>
      <SidebarContent>
        <SidebarMenu>
